"""Integration smoke tests: results-export and ancillary shared modules in influence."""
...
def test_results_schema_key_present():
    html = INDEX.read_text(encoding="utf-8")
    assert 'influence-results-v1' in html, "_schema key 'influence-results-v1' missing from __almResults"
