...
async function run() {
  const csv = fs.readFileSync(path.resolve('C:/HTML apps/dosehtml/coffee_mort_head.csv'), 'utf8').trim();
  ...
  fs.writeFileSync(path.resolve('C:/Users/user/dosehtml_generated_coffee_head.R'), rCode, 'utf8');
