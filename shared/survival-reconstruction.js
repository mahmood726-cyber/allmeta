...
(function (root, factory) {
  // Vendored VERBATIM from registry-ipd/src/engine.js (R-validated, 22/22; goldstandard
  // benchmarked vs ~55 real IPD datasets). Do NOT rewrite the math — re-copy from upstream
  // if it updates. This is a VALIDATED module (oracle/parity-spec-backed), not Experimental.
  // (Convention note: future *claim-only* ports into allmeta should carry an "Experimental"
  // label; this module is exempt because it ships with a numerical-baseline parity spec.)
  if (typeof module === 'object' && module.exports) module.exports = factory();
  else { var api = factory(); root.RIPD = api; root.AlmSurvivalRecon = api; }
