...
const e=AppState.results;
if(,!e||!e.studies)return showToast("Run analysis first","error"),void
const t=event?.target;
...
if(passPeto){
results.passed++;
+' vs R '+refPeto.estimate.toFixed(4)+')');
}else{
results.failed++;
}
...
+' Peto I²:'+peto.heterogeneity.I2.toFixed(1)+'% vs R '+refPeto.I2.toFixed(1)+'%');
}catch(e){
results.failed++;
